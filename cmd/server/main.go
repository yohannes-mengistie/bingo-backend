...
func setupRouter(userHandler *handler.UserHandler, walletHandler *handler.WalletHandler, authHandler *handler.AuthHandler, gameHandler *handler.GameHandler, wsHandler *handler.WebSocketHandler, jwtService *jwt.Service) *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:3000", "https://bingo-frontend-production-7ee9.up.railway.app", "https://biruh-bingo-admin.vercel.app", "https://biruh-bingo-frontend.vercel.app", "https://winner.up.railway.app", "https://biruh-bingo-admin-production.up.railway.app", "https://biruh-bingo-frontend-production.up.railway.app"},

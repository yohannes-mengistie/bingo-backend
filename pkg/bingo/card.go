...
var (
	...
	// Card ID 1-200, each with fixed numbers
...
func generateFixedCards() map[int]*BingoCard {
	...
	cardData := [200][5][5]int{
		...
		// Card 101
        {{6, 17, 34, 48, 72}, {13, 22, 41, 56, 64}, {8, 25, 0, 52, 69}, {1, 19, 39, 47, 75}, {10, 28, 31, 59, 61}},
        // Card 102
        {{4, 21, 38, 55, 63}, {15, 30, 44, 51, 70}, {2, 18, 0, 46, 67}, {9, 24, 32, 60, 73}, {12, 27, 40, 53, 66}},
        // Card 103
        {{11, 20, 36, 57, 74}, {5, 29, 33, 49, 62}, {14, 23, 0, 58, 65}, {7, 16, 42, 50, 71}, {3, 26, 45, 54, 68}},
        // Card 104
        {{1, 25, 43, 46, 61}, {10, 18, 35, 59, 69}, {4, 28, 0, 53, 75}, {13, 21, 40, 52, 64}, {7, 27, 32, 48, 70}},
        // Card 105
        {{15, 22, 31, 50, 72}, {8, 19, 39, 57, 63}, {12, 30, 0, 47, 67}, {2, 16, 41, 55, 74}, {6, 24, 44, 51, 66}},
        // Card 106
        {{5, 26, 38, 54, 68}, {11, 29, 34, 49, 65}, {3, 17, 0, 60, 71}, {14, 23, 37, 56, 73}, {9, 20, 45, 58, 62}},
        // Card 107
        {{10, 18, 42, 51, 75}, {2, 27, 36, 47, 64}, {15, 25, 0, 59, 69}, {6, 21, 31, 53, 61}, {13, 16, 40, 48, 70}},
        // Card 108
        {{4, 30, 33, 55, 67}, {12, 24, 39, 50, 72}, {7, 19, 0, 57, 63}, {1, 22, 45, 54, 74}, {9, 28, 35, 52, 66}},
        // Card 109
        {{14, 29, 38, 46, 62}, {8, 17, 34, 60, 71}, {5, 23, 0, 49, 73}, {11, 26, 37, 58, 68}, {3, 20, 41, 56, 65}},
        // Card 110
        {{7, 24, 31, 52, 69}, {15, 16, 44, 47, 61}, {2, 21, 0, 59, 75}, {10, 19, 36, 50, 64}, {5, 27, 39, 55, 70}},
        // Card 111
        {{12, 25, 33, 48, 72}, {4, 28, 42, 53, 63}, {9, 22, 0, 57, 67}, {1, 18, 45, 49, 74}, {13, 30, 35, 60, 66}},
        // Card 112
        {{11, 23, 41, 56, 68}, {6, 17, 40, 54, 65}, {14, 26, 0, 51, 71}, {3, 20, 37, 46, 73}, {8, 29, 34, 58, 62}},
        // Card 113
        {{15, 27, 32, 53, 64}, {2, 16, 38, 47, 75}, {10, 21, 0, 50, 61}, {5, 24, 43, 59, 69}, {13, 19, 36, 48, 70}},
        // Card 114
        {{7, 28, 45, 55, 67}, {12, 18, 31, 52, 72}, {4, 25, 0, 57, 63}, {9, 22, 39, 51, 74}, {1, 30, 41, 60, 66}},
        // Card 115
        {{14, 20, 35, 46, 62}, {6, 29, 44, 58, 71}, {11, 17, 0, 49, 73}, {3, 26, 34, 54, 68}, {8, 23, 37, 56, 65}},
        // Card 116
        {{10, 16, 42, 59, 69}, {15, 21, 33, 47, 61}, {5, 25, 0, 52, 75}, {2, 27, 40, 50, 64}, {13, 18, 31, 48, 70}},
        // Card 117
        {{12, 24, 45, 53, 67}, {4, 30, 36, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 38, 51, 74}, {9, 22, 43, 60, 66}},
        // Card 118
        {{11, 23, 32, 46, 62}, {14, 17, 39, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 41, 54, 68}, {8, 26, 34, 56, 65}},
        // Card 119
        {{15, 21, 35, 52, 61}, {10, 16, 44, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 31, 50, 64}, {13, 18, 37, 48, 70}},
        // Card 120
        {{7, 28, 33, 55, 72}, {12, 30, 42, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 40, 51, 74}, {1, 24, 45, 60, 66}},
        // Card 121
        {{14, 20, 38, 46, 68}, {6, 17, 36, 54, 65}, {11, 26, 0, 51, 71}, {3, 23, 43, 56, 73}, {8, 29, 32, 58, 62}},
        // Card 122
        {{10, 16, 41, 59, 64}, {15, 21, 34, 47, 75}, {5, 25, 0, 50, 61}, {2, 27, 39, 48, 69}, {13, 18, 44, 52, 70}},
        // Card 123
        {{12, 24, 31, 53, 67}, {4, 30, 42, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 35, 51, 74}, {9, 22, 45, 60, 66}},
        // Card 124
        {{11, 23, 33, 46, 62}, {14, 17, 40, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 38, 54, 68}, {8, 26, 43, 56, 65}},
        // Card 125
        {{15, 21, 36, 52, 61}, {10, 16, 31, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 37, 50, 64}, {13, 18, 32, 48, 70}},
        // Card 126
        {{7, 28, 44, 55, 72}, {12, 30, 34, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 41, 51, 74}, {1, 24, 39, 60, 66}},
        // Card 127
        {{14, 20, 45, 46, 68}, {6, 17, 35, 54, 65}, {11, 26, 0, 51, 71}, {3, 23, 33, 56, 73}, {8, 29, 42, 58, 62}},
        // Card 128
        {{10, 16, 40, 59, 64}, {15, 21, 38, 47, 75}, {5, 25, 0, 50, 61}, {2, 27, 32, 48, 69}, {13, 18, 43, 52, 70}},
        // Card 129
        {{12, 24, 36, 53, 67}, {4, 30, 31, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 44, 51, 74}, {9, 22, 34, 60, 66}},
        // Card 130
        {{11, 23, 45, 46, 62}, {14, 17, 37, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 35, 54, 68}, {8, 26, 41, 56, 65}},
        // Card 131
        {{15, 21, 32, 52, 61}, {10, 16, 40, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 33, 50, 64}, {13, 18, 42, 48, 70}},
        // Card 132
        {{7, 28, 38, 55, 72}, {12, 30, 39, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 31, 51, 74}, {1, 24, 43, 60, 66}},
        // Card 133
        {{14, 20, 34, 46, 68}, {6, 17, 44, 54, 65}, {11, 26, 0, 51, 71}, {3, 23, 45, 56, 73}, {8, 29, 36, 58, 62}},
        // Card 134
        {{10, 16, 35, 59, 64}, {15, 21, 41, 47, 75}, {5, 25, 0, 50, 61}, {2, 27, 40, 48, 69}, {13, 18, 31, 52, 70}},
        // Card 135
        {{12, 24, 33, 53, 67}, {4, 30, 45, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 32, 51, 74}, {9, 22, 38, 60, 66}},
        // Card 136
        {{11, 23, 39, 46, 62}, {14, 17, 31, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 44, 54, 68}, {8, 26, 35, 56, 65}},
        // Card 137
        {{15, 21, 42, 52, 61}, {10, 16, 36, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 43, 50, 64}, {13, 18, 34, 48, 70}},
        // Card 138
        {{7, 28, 40, 55, 72}, {12, 30, 41, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 44, 51, 74}, {1, 24, 32, 60, 66}},
        // Card 139
        {{14, 20, 31, 46, 68}, {6, 17, 33, 54, 65}, {11, 26, 0, 51, 71}, {3, 23, 38, 56, 73}, {8, 29, 45, 58, 62}},
        // Card 140
        {{10, 16, 37, 59, 64}, {15, 21, 42, 47, 75}, {5, 25, 0, 50, 61}, {2, 27, 34, 48, 69}, {13, 18, 36, 52, 70}},
        // Card 141
        {{12, 24, 44, 53, 67}, {4, 30, 40, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 31, 51, 74}, {9, 22, 41, 60, 66}},
        // Card 142
        {{11, 23, 35, 46, 62}, {14, 17, 43, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 32, 54, 68}, {8, 26, 39, 56, 65}},
        // Card 143
        {{15, 21, 31, 52, 61}, {10, 16, 38, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 45, 50, 64}, {13, 18, 33, 48, 70}},
        // Card 144
        {{7, 28, 37, 55, 72}, {12, 30, 32, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 36, 51, 74}, {1, 24, 42, 60, 66}},
        // Card 145
        {{14, 20, 41, 46, 68}, {6, 17, 40, 54, 65}, {11, 26, 0, 51, 71}, {3, 23, 34, 56, 73}, {8, 29, 31, 58, 62}},
        // Card 146
        {{10, 16, 33, 59, 64}, {15, 21, 44, 47, 75}, {5, 25, 0, 50, 61}, {2, 27, 38, 48, 69}, {13, 18, 45, 52, 70}},
        // Card 147
        {{12, 24, 35, 53, 67}, {4, 30, 39, 55, 72}, {7, 19, 0, 57, 63}, {1, 28, 43, 51, 74}, {9, 22, 37, 60, 66}},
        // Card 148
        {{11, 23, 32, 46, 62}, {14, 17, 34, 58, 71}, {6, 29, 0, 49, 73}, {3, 20, 31, 54, 68}, {8, 26, 40, 56, 65}},
        // Card 149
        {{15, 21, 39, 52, 61}, {10, 16, 45, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 41, 50, 64}, {13, 18, 35, 48, 70}},
        // Card 150
        {{7, 28, 33, 55, 72}, {12, 30, 44, 53, 63}, {4, 19, 0, 57, 67}, {9, 22, 38, 51, 74}, {1, 24, 40, 60, 66}},
		// Card 151
        {{2, 17, 34, 58, 62}, {11, 29, 36, 49, 73}, {14, 26, 0, 51, 65}, {3, 23, 41, 56, 68}, {8, 20, 32, 46, 71}},
        // Card 152
        {{15, 19, 39, 47, 69}, {5, 25, 33, 52, 75}, {10, 21, 0, 59, 61}, {2, 27, 43, 50, 70}, {13, 18, 31, 48, 64}},
        // Card 153
        {{12, 30, 42, 53, 63}, {4, 24, 35, 55, 74}, {7, 22, 0, 57, 67}, {1, 28, 44, 51, 66}, {9, 16, 45, 60, 72}},
        // Card 154
        {{6, 29, 31, 46, 65}, {14, 17, 38, 54, 71}, {11, 20, 0, 49, 73}, {8, 26, 37, 58, 62}, {3, 23, 40, 56, 68}},
        // Card 155
        {{10, 21, 44, 47, 61}, {15, 16, 32, 59, 75}, {5, 25, 0, 50, 69}, {13, 18, 41, 52, 70}, {2, 27, 36, 48, 64}},
        // Card 156
        {{7, 22, 33, 57, 67}, {12, 30, 45, 51, 74}, {4, 19, 0, 53, 63}, {9, 28, 42, 55, 66}, {1, 24, 39, 60, 72}},
        // Card 157
        {{11, 26, 40, 51, 71}, {6, 17, 43, 46, 65}, {14, 29, 0, 58, 73}, {3, 20, 35, 54, 62}, {8, 23, 38, 56, 68}},
        // Card 158
        {{5, 25, 31, 59, 75}, {10, 16, 34, 50, 61}, {15, 21, 0, 47, 69}, {2, 27, 37, 48, 70}, {13, 18, 42, 52, 64}},
        // Card 159
        {{4, 19, 36, 53, 63}, {7, 30, 32, 57, 67}, {12, 22, 0, 51, 74}, {1, 24, 44, 60, 72}, {9, 28, 41, 55, 66}},
        // Card 160
        {{14, 29, 45, 49, 73}, {11, 26, 42, 58, 65}, {6, 17, 0, 51, 71}, {8, 23, 33, 56, 62}, {3, 20, 39, 54, 68}},
        // Card 161
        {{15, 21, 40, 47, 69}, {5, 25, 38, 59, 75}, {10, 16, 0, 50, 61}, {13, 18, 35, 52, 70}, {2, 27, 44, 48, 64}},
        // Card 162
        {{12, 22, 43, 51, 74}, {4, 19, 37, 53, 63}, {7, 30, 0, 57, 67}, {9, 28, 31, 55, 66}, {1, 24, 34, 60, 72}},
        // Card 163
        {{6, 17, 41, 51, 71}, {14, 29, 36, 46, 65}, {11, 26, 0, 58, 73}, {3, 20, 32, 54, 62}, {8, 23, 45, 56, 68}},
        // Card 164
        {{10, 16, 33, 50, 61}, {15, 21, 42, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 39, 48, 64}, {13, 18, 38, 52, 70}},
        // Card 165
        {{7, 30, 40, 57, 67}, {12, 22, 35, 51, 74}, {4, 19, 0, 53, 63}, {1, 24, 31, 60, 72}, {9, 28, 44, 55, 66}},
        // Card 166
        {{11, 26, 34, 58, 73}, {6, 17, 37, 51, 71}, {14, 29, 0, 49, 65}, {8, 23, 43, 56, 68}, {3, 20, 41, 54, 62}},
        // Card 167
        {{5, 25, 45, 59, 75}, {10, 16, 36, 50, 61}, {15, 21, 0, 47, 69}, {13, 18, 32, 52, 70}, {2, 27, 33, 48, 64}},
        // Card 168
        {{4, 19, 42, 53, 63}, {7, 30, 41, 57, 67}, {12, 22, 0, 51, 74}, {9, 28, 40, 55, 66}, {1, 24, 35, 60, 72}},
        // Card 169
        {{14, 29, 39, 49, 73}, {11, 26, 31, 58, 65}, {6, 17, 0, 51, 71}, {3, 20, 44, 54, 68}, {8, 23, 34, 56, 62}},
        // Card 170
        {{15, 21, 38, 47, 69}, {5, 25, 43, 59, 75}, {10, 16, 0, 50, 61}, {2, 27, 35, 48, 64}, {13, 18, 37, 52, 70}},
        // Card 171
        {{12, 22, 33, 51, 74}, {4, 19, 31, 53, 63}, {7, 30, 0, 57, 67}, {1, 24, 42, 60, 72}, {9, 28, 36, 55, 66}},
        // Card 172
        {{6, 17, 45, 51, 71}, {14, 29, 32, 46, 65}, {11, 26, 0, 58, 73}, {8, 23, 40, 56, 68}, {3, 20, 34, 54, 62}},
        // Card 173
        {{10, 16, 41, 50, 61}, {15, 21, 39, 47, 69}, {5, 25, 0, 59, 75}, {13, 18, 44, 52, 70}, {2, 27, 35, 48, 64}},
        // Card 174
        {{7, 30, 37, 57, 67}, {12, 22, 38, 51, 74}, {4, 19, 0, 53, 63}, {9, 28, 33, 55, 66}, {1, 24, 43, 60, 72}},
        // Card 175
        {{11, 26, 31, 58, 73}, {6, 17, 42, 51, 71}, {14, 29, 0, 49, 65}, {3, 20, 45, 54, 62}, {8, 23, 36, 56, 68}},
        // Card 176
        {{5, 25, 34, 59, 75}, {10, 16, 40, 50, 61}, {15, 21, 0, 47, 69}, {2, 27, 32, 48, 64}, {13, 18, 41, 52, 70}},
        // Card 177
        {{4, 19, 44, 53, 63}, {7, 30, 35, 57, 67}, {12, 22, 0, 51, 74}, {1, 24, 38, 60, 72}, {9, 28, 39, 55, 66}},
        // Card 178
        {{14, 29, 33, 49, 73}, {11, 26, 41, 58, 65}, {6, 17, 0, 51, 71}, {8, 23, 31, 56, 62}, {3, 20, 42, 54, 68}},
        // Card 179
        {{15, 21, 45, 47, 69}, {5, 25, 37, 59, 75}, {10, 16, 0, 50, 61}, {13, 18, 36, 52, 70}, {2, 27, 40, 48, 64}},
        // Card 180
        {{12, 22, 34, 51, 74}, {4, 19, 43, 53, 63}, {7, 30, 0, 57, 67}, {9, 28, 32, 55, 66}, {1, 24, 41, 60, 72}},
        // Card 181
        {{6, 17, 35, 51, 71}, {14, 29, 44, 46, 65}, {11, 26, 0, 58, 73}, {3, 20, 31, 54, 62}, {8, 23, 33, 56, 68}},
        // Card 182
        {{10, 16, 38, 50, 61}, {15, 21, 36, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 42, 48, 64}, {13, 18, 39, 52, 70}},
        // Card 183
        {{7, 30, 45, 57, 67}, {12, 22, 31, 51, 74}, {4, 19, 0, 53, 63}, {1, 24, 40, 60, 72}, {9, 28, 37, 55, 66}},
        // Card 184
        {{11, 26, 44, 58, 73}, {6, 17, 32, 51, 71}, {14, 29, 0, 49, 65}, {8, 23, 35, 56, 68}, {3, 20, 38, 54, 62}},
        // Card 185
        {{5, 25, 41, 59, 75}, {10, 16, 43, 50, 61}, {15, 21, 0, 47, 69}, {13, 18, 34, 52, 70}, {2, 27, 31, 48, 64}},
        // Card 186
        {{4, 19, 39, 53, 63}, {7, 30, 40, 57, 67}, {12, 22, 0, 51, 74}, {9, 28, 45, 55, 66}, {1, 24, 33, 60, 72}},
        // Card 187
        {{14, 29, 37, 49, 73}, {11, 26, 35, 58, 65}, {6, 17, 0, 51, 71}, {3, 20, 31, 54, 68}, {8, 23, 42, 56, 62}},
        // Card 188
        {{15, 21, 32, 47, 69}, {5, 25, 44, 59, 75}, {10, 16, 0, 50, 61}, {2, 27, 43, 48, 64}, {13, 18, 36, 52, 70}},
        // Card 189
        {{12, 22, 38, 51, 74}, {4, 19, 45, 53, 63}, {7, 30, 0, 57, 67}, {1, 24, 31, 60, 72}, {9, 28, 34, 55, 66}},
        // Card 190
        {{6, 17, 40, 51, 71}, {14, 29, 41, 46, 65}, {11, 26, 0, 58, 73}, {8, 23, 32, 56, 68}, {3, 20, 43, 54, 62}},
        // Card 191
        {{10, 16, 42, 50, 61}, {15, 21, 35, 47, 69}, {5, 25, 0, 59, 75}, {13, 18, 31, 52, 70}, {2, 27, 39, 48, 64}},
        // Card 192
        {{7, 30, 34, 57, 67}, {12, 22, 44, 51, 74}, {4, 19, 0, 53, 63}, {9, 28, 38, 55, 66}, {1, 24, 36, 60, 72}},
        // Card 193
        {{11, 26, 45, 58, 73}, {6, 17, 39, 51, 71}, {14, 29, 0, 49, 65}, {3, 20, 33, 54, 62}, {8, 23, 31, 56, 68}},
        // Card 194
        {{5, 25, 40, 59, 75}, {10, 16, 32, 50, 61}, {15, 21, 0, 47, 69}, {2, 27, 37, 48, 64}, {13, 18, 43, 52, 70}},
        // Card 195
        {{4, 19, 31, 53, 63}, {7, 30, 42, 57, 67}, {12, 22, 0, 51, 74}, {1, 24, 45, 60, 72}, {9, 28, 35, 55, 66}},
        // Card 196
        {{14, 29, 44, 49, 73}, {11, 26, 38, 58, 65}, {6, 17, 0, 51, 71}, {8, 23, 34, 56, 62}, {3, 20, 36, 54, 68}},
        // Card 197
        {{15, 21, 33, 47, 69}, {5, 25, 31, 59, 75}, {10, 16, 0, 50, 61}, {13, 18, 40, 52, 70}, {2, 27, 41, 48, 64}},
        // Card 198
        {{12, 22, 45, 51, 74}, {4, 19, 32, 53, 63}, {7, 30, 0, 57, 67}, {9, 28, 43, 55, 66}, {1, 24, 37, 60, 72}},
        // Card 199
        {{6, 17, 38, 51, 71}, {14, 29, 35, 46, 65}, {11, 26, 0, 58, 73}, {3, 20, 44, 54, 62}, {8, 23, 39, 56, 68}},
        // Card 200
        {{10, 16, 45, 50, 61}, {15, 21, 31, 47, 69}, {5, 25, 0, 59, 75}, {2, 27, 34, 48, 64}, {13, 18, 33, 52, 70}},
	}
